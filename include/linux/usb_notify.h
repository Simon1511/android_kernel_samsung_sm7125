...
static inline int get_typec_status(struct otg_notify *n, int event)
{
	return 0;
}
...
static inline int get_booster(struct otg_notify *n)
{
	return 0;
}
static inline int get_usb_mode(struct otg_notify *n)
{
	return 0;
}
static inline unsigned long get_cable_type(struct otg_notify *n)
{
	return 0;
}
static inline int is_usb_host(struct otg_notify *n)
{
	return 0;
}
static inline bool is_blocked(struct otg_notify *n, int type)
{
	return false;
}
...
#endif
static inline void *get_notify_data(struct otg_notify *n)
{
	return NULL;
}
...
static inline int set_otg_notify(struct otg_notify *n)
{
	return 0;
}
